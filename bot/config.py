...
ALTERNATIVE_CURRENCY: str = "£"
SHOW_ALTERNATIVE_CURRENCY_DEFAULT: bool = False
CONVERSION_RATE_TO_ALTERNATIVE_CURRENCY: int = 6
ALTERNATIVE_CURRENCY_SYMBOL_BEFORE_AMOUNT: bool = True
